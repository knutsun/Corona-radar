...
class GetLatestNumbersByLocationIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = 'In {} county {}, {} people have died and there are {} existing cases of coronavirus'.format(str(county_response.json()['County']), state_or_region, nyt[0], nyt[1])
